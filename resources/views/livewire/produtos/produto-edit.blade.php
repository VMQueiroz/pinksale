                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6">
                                ...
                                <div class="mt-1">
                                    <img src="{{ Storage::url($imagem) }}" alt="{{ $nome }}" class="h-32 w-32 object-cover">
                                </div>
                            </div>
                            @endif

                            <div class="col-span-6">
                                <x-input-label for="nova_imagem" value="Nova Imagem" />
                                <input wire:model="nova_imagem" type="file" class="mt-1 block w-full" />
                                <x-input-error :messages="$errors->get('nova_imagem')" class="mt-2" />
                            </div>
