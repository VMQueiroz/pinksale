    ...
    <form wire:submit.prevent="save" class="space-y-6">
        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            ...
            <div class="sm:col-span-2">
                <x-input-label for="data_entrevista" value="Data da Entrevista" />
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <x-input wire:model="data_entrevista" id="data_entrevista" type="date" class="pl-10 block w-full border-gray-300 focus:border-pk focus:ring-pk rounded-md shadow-sm" required />
                </div>
                <x-input-error :messages="$errors->get('data_entrevista')" class="mt-2" />
            </div>
        ...
        <div class="border-t border-gray-200 pt-4">
            @if($entrevista && $entrevista->exists && $entrevista->isPendente())
            ...
            <div class="flex justify-end space-x-3">
                ...
                <x-primary-button type="submit" class="flex items-center">
                    ...
                    {{ isset($entrevista) && $entrevista ? 'Atualizar Entrevista' : 'Agendar Entrevista' }}
                </x-primary-button>
            </div>
        </div>
    </form>
