    ...
    <form wire:submit="save" class="space-y-6">
        <div class="grid grid-cols-1 sm:grid-cols-6 gap-4">
            ...
            <div class="sm:col-span-4">
                ...
                <x-input wire:model="nome" id="nome" type="text" class="mt-1 block w-full" required />
            ...
            <div class="sm:col-span-4">
                ...
                <x-input wire:model="endereco" id="endereco" type="text" class="mt-1 block w-full"/>
                <x-input-error :messages="$errors->get('endereco')" class="mt-2" />
            </div>

            <div class="sm:col-span-2">
                <x-input-label for="numero" value="Número" />
                <x-input wire:model="numero" id="numero" type="text" class="mt-1 block w-full"/>
                <x-input-error :messages="$errors->get('numero')" class="mt-2" />
            </div>

            <div class="sm:col-span-2">
                <x-input-label for="complemento" value="Complemento" />
                <x-input wire:model="complemento" id="complemento" type="text" class="mt-1 block w-full" />
                <x-input-error :messages="$errors->get('complemento')" class="mt-2" />
            </div>

            <div class="sm:col-span-3">
                <x-input-label for="cidade" value="Cidade" />
                <x-input wire:model="cidade" id="cidade" type="text" class="mt-1 block w-full"/>
                <x-input-error :messages="$errors->get('cidade')" class="mt-2" />
            </div>

            <div class="sm:col-span-1">
                <x-input-label for="estado" value="UF" />
                <x-input wire:model="estado" id="estado" type="text" class="mt-1 block w-full"/>
            ...
            <div class="sm:col-span-3">
                ...
                <x-input wire:model="data_inicio" id="data_inicio" type="date" class="mt-1 block w-full"/>
